...
export default {
  async fetch(request, env, ctx) {
    ...
    newHeaders.set(
      ...
      // applepay.cdn-apple.com: Apple's own Apple Pay JS SDK, loaded by
      // Stax.js's ApplePayFieldFactory when it tries to render the wallet
      // button added to the parent billing modal. Caught live: "Loading the
      // script 'https://applepay.cdn-apple.com/jsapi/1.latest/apple-pay-sdk.js'
      // violates ... script-src" on a real attempt to view the button.
      "script-src 'self' 'sha256-7ukUEU0HbQk9LYpgmbPE9MqGzatu6rzksJn1AYYw+2Y=' 'sha256-ALMh8fut/JHHMeP2T/kM/nHWJax99rJ7egy7UofChXU=' 'sha256-aGIMO7Vlhq6Ve/meGqKde1A3T79E/OD1yrByOQjBZEs=' 'sha256-d5i+v5L8VusXhEGQOmuyU+EkXjSx6GzmGomWRzUra5E=' 'sha256-dTRmBgLLPM8GxN9hmnDU3nEMwlrkK674AC3bzP8oBwg=' 'sha256-fI8T92E60IJncE+OcbC++7XsYQdClalyTG+sT6hOqjU=' 'sha256-h/EXOjMCF9Rgr2ZXcKL04RuCl+rAmgCHPfu+j8lv+C4=' 'sha256-mvVo0ENcU3SS5xg3ePKPQAekybTJ3D42djIbf0IYr3U=' 'sha256-n6CQ/BTNYeil2JNqHWbFGXfnDHnjETuGFmwVFH3n0EE=' 'sha256-ne+dzcRgNOXDz83q9TjqqPWPaEmzzwNuQkGLyRJE+a0=' 'sha256-iTKYZsYG5rS6dc0SuMvsRH7EkRnYo3EP4zVcf/vhZi8=' 'sha256-qrg7scMqtNWjm70X6OTSMAvNP7CnjeDya3YC/hXSBEE=' 'sha256-r5ECVyxfLY+rle5ekHeP4wZC/bZ4bgxBT5+2Fsc2l+k=' 'sha256-sLrSHxNtqFHjQT/zbfGa3pxd/G5xWp/cHbuTHNVkOZA=' 'sha256-vQzgczDFy/iatRc6pEF4+sxzSIrVGotATlJfQz7EfO0=' https://cdn.jsdelivr.net https://static.cloudflareinsights.com https://staxjs.staxpayments.com https://core.spreedly.com https://www.google.com https://www.gstatic.com https://secure.networkmerchants.com https://applepay.cdn-apple.com; " +
      ...
      // collectcheckout.com/token/{apple,google}_pay_field.php instead. Found
      // live by inspecting the wallet button mount in DevTools: the iframe's
      // #document had navigated to chrome-error://chromewebdata/, Chrome's
